...
- **Athletes control content only.** Athletes edit an athlete's name, stats, offers, schedule, etc. They cannot edit theme name, arrangement, or any design elements. (Card show/hide toggles were cut from the product 2026-07-08 — a card renders when it has data and is omitted when empty, no manual switch.)
